...
export function EducationSection() {
  return (
    <Section id="education" className="bg-[#fff7f7]/50">
      <FadeUp>
        <SectionHeader
          title="Education"
      ...
      <div className="mx-auto max-w-5xl space-y-6">
        {education.map((edu, index) => (
          <ScaleIn key={edu.id} delay={index * 0.12}>
            <article className="group overflow-hidden rounded-3xl border border-slate-200/80 bg-white/90 shadow-sm shadow-slate-200/40 transition-all duration-300 hover:-translate-y-1 hover:border-[#fca5a5] hover:shadow-xl hover:shadow-[#dc2626]/12">
              <div className="h-1.5 bg-gradient-to-r from-[#991b1b] via-[#dc2626] to-[#fca5a5]" />
              ...
              <div className="p-6 sm:p-8">
                    ...
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                      <div>
                        <div className="mb-2 flex flex-wrap items-center gap-2">
                          <span className="inline-flex items-center gap-1.5 rounded-full bg-[#fef2f2] px-3 py-1 text-xs font-semibold text-[#991b1b] ring-1 ring-inset ring-[#fecaca]">
                        ...
                        <h3 className="text-xl font-bold leading-snug text-slate-900 transition-colors group-hover:text-[#991b1b] sm:text-2xl">
                          {edu.institution}
                        </h3>
                      </div>
                      ...
                      <div className="flex shrink-0 flex-wrap gap-2">
                        <span className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs font-semibold text-slate-600">
                          <Calendar size={14} className="text-[#991b1b]" aria-hidden="true" />
                          {edu.period}
                        </span>
                        <span className="inline-flex items-center gap-1.5 rounded-xl border border-amber-200/70 bg-amber-50 px-3 py-2 text-xs font-semibold text-slate-700">
                          ...
                          GPA <strong className="text-[#991b1b]">{edu.gpa}</strong>
                        </span>
                      </div>
                    </div>

                    <div className="mt-5 flex items-start gap-3 rounded-2xl bg-slate-50/80 p-4 ring-1 ring-inset ring-slate-100">
                      <BookOpen size={18} className="mt-0.5 shrink-0 text-[#991b1b]" aria-hidden="true" />
                      <div>
                ...
                {edu.internship && (
                  <div className="mt-7 rounded-2xl border border-[#fecaca] bg-gradient-to-br from-[#fef2f2]/80 to-[#fff7f7]/40 p-4 sm:ml-[104px]">
                    <div className="space-y-5">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="mt-1 block text-sm font-medium leading-relaxed text-[#991b1b]">
